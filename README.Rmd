...
to the stats package, therefore making this compatible with packages such as sandwich for robust estimation, even if that means to attenuate the speed gains.
...
I fitted computationally complex model from [Yotov, et. al. (2016)](https://pacha.dev/yotover/partial-equilibrium-trade-policy-analysis-with-structural-gravity.html#ppml-estimation-controlling-for-multilateral-resistance-terms-with-fixed-effects).
