...
#' summary method for eglm fitted objects
#'
#' @param object eglm fitted object
...
#' residuals method for eglm fitted objects
#'
#' @param object eglm fitted object
...
#' @rdname residuals
#' @method residuals eglm
#' @export
residuals.eglm <- function(object,
...
#' logLik method for eglm fitted objects
#'
#' @param object eglm fitted object
#' @param ... not used
...
#' deviance method for eglm fitted objects
#'
#' @param object eglm fitted object
#' @param ... not used
#' @return The value of the deviance extracted from the object
#' @rdname deviance
#' @method deviance eglm
#' @export
deviance.eglm <- function(object, ...) {
  deviance.glm(object, ...)
}

#' family method for eglm fitted objects
#'
#' @param object eglm fitted object
#' @param ... not used
...
#' @param object a fitted object of class inheriting from "\code{eglm}".
...
predict.eglm <- function(object,
  ...
  eta <- predict_eglm_lm(object, newdata, se.fit, scale = 1, ...)
  if (type == "response") {
...
predict_eglm_lm <- function(object, newdata, se.fit = FALSE, scale = 1) {
  if (se.fit) {
