...
#'
#' elm is used to fit linear models in an equivalent way to \code{lm} but in
#' a reduced time depending on the design matrix (see the DESCRIPTION).
#'
...
#' @export
elm <- function(formula, data, intercept = TRUE, weights = NULL,
