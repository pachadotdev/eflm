...
RcppExport SEXP _eflm_colMax_dense(SEXP ASEXP) {
BEGIN_RCPP
...
RcppExport SEXP _eflm_colMin_dense(SEXP ASEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::MatrixXd>& >::type A(ASEXP);
...
RcppExport SEXP _eflm_fit_glm(SEXP xSEXP, SEXP ySEXP, SEXP weightsSEXP, SEXP offsetSEXP, SEXP startSEXP, SEXP muSEXP, SEXP etaSEXP, SEXP varSEXP, SEXP mu_etaSEXP, SEXP linkinvSEXP, SEXP dev_residsSEXP, SEXP validetaSEXP, SEXP validmuSEXP, SEXP typeSEXP, SEXP tolSEXP, SEXP maxitSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_eflm_colMax_dense", (DL_FUNC) &_eflm_colMax_dense, 1},
    {"_eflm_colMin_dense", (DL_FUNC) &_eflm_colMin_dense, 1},
    {"_eflm_fit_glm", (DL_FUNC) &_eflm_fit_glm, 16},
    {NULL, NULL, 0}
};

RcppExport void R_init_eflm(DllInfo *dll) {
