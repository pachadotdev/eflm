# test_that("elm + vcovCL return the same as lm + vcovCL", {
#   m1 <- lm(mpg ~ wt, data = mtcars)
#   m2 <- eflm::elm(mpg ~ wt, data = mtcars, reduce = F)
#   m3 <- eflm::elm(mpg ~ wt, data = mtcars, reduce = T)
#
#   vcov_m1 <- sandwich::vcovCL(m1, cluster = NULL, type = "HC1")
#   vcov_m2 <- sandwich::vcovCL(m2, cluster = NULL, type = "HC1")
#   vcov_m3 <- sandwich::vcovCL(m3, cluster = NULL, type = "HC1")
#
...
#   vcov_m3 <- sandwich::vcovCL(m3, cluster = eval(m3$call$data)[, "cyl"], type = "HC1")
#
#   expect_equal(vcov_m2, vcov_m1)
#   expect_equal(vcov_m3, vcov_m1)
# })
