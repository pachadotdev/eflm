...
test_that("eglm (gaussian) == glm", {
  m1 <- glm(mpg ~ wt + am, family = gaussian, data = mtcars, weights = mtcars$cyl)
  m2 <- eglm(mpg ~ wt + am, family = gaussian, data = mtcars, weights = mtcars$cyl, reduce = F)
  m3 <- eglm(mpg ~ wt + am, family = gaussian, data = mtcars, weights = mtcars$cyl, reduce = T)
...
test_that("eglm (inverse.gaussian) == glm", {
  m1 <- glm(mpg ~ wt + am, family = inverse.gaussian, data = mtcars, weights = mtcars$cyl)
  m2 <- eglm(mpg ~ wt + am, family = inverse.gaussian, data = mtcars, weights = mtcars$cyl, reduce = F)
  m3 <- eglm(mpg ~ wt + am, family = inverse.gaussian, data = mtcars, weights = mtcars$cyl, reduce = T)
...
test_that("eglm (gamma) == glm", {
  m1 <- glm(mpg ~ wt + am, family = Gamma, data = mtcars, weights = mtcars$cyl)
  m2 <- eglm(mpg ~ wt + am, family = Gamma, data = mtcars, weights = mtcars$cyl, reduce = F)
  m3 <- eglm(mpg ~ wt + am, family = Gamma, data = mtcars, weights = mtcars$cyl, reduce = T)
...
test_that("eglm (binomial) == glm", {
  m1 <- glm(am ~ wt + mpg, family = binomial, data = mtcars, weights = mtcars$cyl)
  m2 <- eglm(am ~ wt + mpg, family = binomial, data = mtcars, weights = mtcars$cyl, reduce = F)
  m3 <- eglm(am ~ wt + mpg, family = binomial, data = mtcars, weights = mtcars$cyl, reduce = T)
...
test_that("eglm (quasibinomial) == glm", {
  m1 <- glm(am ~ wt + mpg, family = quasibinomial, data = mtcars, weights = mtcars$cyl)
  m2 <- eglm(am ~ wt + mpg, family = quasibinomial, data = mtcars, weights = mtcars$cyl, reduce = F)
  m3 <- eglm(am ~ wt + mpg, family = quasibinomial, data = mtcars, weights = mtcars$cyl, reduce = T)
...
test_that("eglm (poisson) == glm", {
  m1 <- glm(am ~ wt + mpg, family = poisson, data = mtcars, weights = mtcars$cyl)
  m2 <- eglm(am ~ wt + mpg, family = poisson, data = mtcars, weights = mtcars$cyl, reduce = F)
  m3 <- eglm(am ~ wt + mpg, family = poisson, data = mtcars, weights = mtcars$cyl, reduce = T)
...
test_that("eglm (quasipoisson) == glm", {
  m1 <- glm(mpg ~ wt + am, family = quasipoisson, data = mtcars, weights = mtcars$cyl)
  m2 <- eglm(mpg ~ wt + am, family = quasipoisson, data = mtcars, weights = mtcars$cyl, reduce = F)
  m3 <- eglm(mpg ~ wt + am, family = quasipoisson, data = mtcars, weights = mtcars$cyl, reduce = T)
...
test_that("eglm (quasi) == glm", {
  m1 <- glm(mpg ~ wt + am, family = quasi, data = mtcars, weights = mtcars$cyl)
  m2 <- eglm(mpg ~ wt + am, family = quasi, data = mtcars, weights = mtcars$cyl, reduce = F)
  m3 <- eglm(mpg ~ wt + am, family = quasi, data = mtcars, weights = mtcars$cyl, reduce = T)
...
test_that("eglm logit fails to converge with a large number of variables", {
  ...
  expect_warning(
    expect_warning(glm(am ~ ., family = binomial, data = mtcars, weights = mtcars$cyl))
  )
  ...
  expect_warning(
    expect_warning(eglm(am ~ ., family = binomial, data = mtcars, weights = mtcars$cyl, reduce = F))
  )

  expect_warning(
    expect_warning(eglm(am ~ ., family = binomial, data = mtcars, weights = mtcars$cyl, reduce = T))
  )
})
...
test_that("eglm returns the design matrix the same as glm", {
  m1 <- glm(mpg ~ wt, data = mtcars, weights = mtcars$cyl, x = TRUE)
  m2 <- eglm(mpg ~ wt, data = mtcars, weights = mtcars$cyl, x = TRUE, reduce = FALSE)
  m3 <- eglm(mpg ~ wt, data = mtcars, weights = mtcars$cyl, x = TRUE, reduce = TRUE)
